...
#config['apikey'] = "dc88f2b1bc15c1ccfd799d59821fcf3304598bea"
...
"""
config['urls']['movie.search'] = "http://api.themoviedb.org/2.1/Movie.search/ru/xml/%(apikey)s/%%s" % (config)
config['urls']['movie.getInfo'] = "http://api.themoviedb.org/2.1/Movie.getInfo/ru/xml/%(apikey)s/%%s" % (config)
config['urls']['movie.imdbLookup'] = "http://api.themoviedb.org/2.1/Movie.imdbLookup/ru/xml/%(apikey)s/%%s" % (config)
config['urls']['media.getInfo'] = "http://api.themoviedb.org/2.1/Media.getInfo/ru/xml/%(apikey)s/%%s/%%s" % (config)
...
def searchByHashingFile(filename):
    ...
    """
    return mediaGetInfo(opensubtitleHashFile(filename), os.stat(filename).st_size)
